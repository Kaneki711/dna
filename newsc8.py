...
def ririnBot(op):
    try:
        ...
        if op.type == 5:
            ...
            ririn.sendMessage(to, "ʜᴀʏ, sᴀʟᴀᴍ ᴋᴇɴᴀʟ ʏᴀ")
        ...
        if op.type == 13:
            ...
            if ririnMid in op.param3:
                ...
                ririn.sendMessage(op.param1, "ʜᴀʏ, sᴀʟᴀᴍ ᴋᴇɴᴀʟ ʏᴀ")
        ...
        if op.type == 17:
        	dan = ririn.getContact(op.param2)
        	tgb = ririn.getGroup(op.param1)
        	sendMention(op.param1, "╭❂➣━━━━━━━━━━━━━━━━━━➣\n┃❂ ᴡ  ᴇ  ʟ  ᴄ  ᴏ  ᴍ  ᴇ \n┃❂sɪʟᴀʜᴋᴀɴ ᴄᴇᴋ ᴅᴀғᴛᴀʀ ᴀɴɢɢᴏᴛᴀ..\n┃❂ᴋᴀʟᴀᴜ ᴀᴅᴀ ʏᴀɴɢ ᴄᴏᴄᴏᴋ ᴛɪᴋᴜɴɢ ɢɪʜ \n╰❂➣━━━━━━━━━━━━━━━━━━➣".format(str(tgb.name)),[op.param2])
        	ririn.sendContact(op.param1, op.param2)
        	ririn.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net{}".format(dan.picturePath))
        ...
        if op.type in [22, 24]:
            ...
            if wait["autoLeave"] == True:
                sendMention(op.param1, "izin dulu @!         ,\nkalau mau jepit")
...
# Pembatas Script #
                        ...
                        if wait["checkPost"] == True:
                            try:
                                ...
                                ririn.sendMessage(to, "❂➣ ᴄɪᴇᴇ.. ᴄɪᴇᴇ..😱")
            except Exception as error:
                logError(error)
                            ...
                            for mention in mentionees:
                                if ririnMid in mention["M"]:
                                    if wait["autoRespon"] == True:
                                    	...
                                    	contact = ririn.getContact(msg._from)
                                    	ririn.sendImageWithURL(msg._from, "http://dl.profile.line-cdn.net{}".format(contact.picturePath))
                                    	sendMention(sender, "😄 @!      ,\nᴊᴏᴍʙʟᴏ ᴍᴇᴍᴀɴɢ ᴋᴇʀᴊᴀᴀɴʏᴀ ɴɢᴇᴛᴀɢ ᴍᴜʟᴜ", [sender])
                                    	dee = "" + random.choice(balas)
                                    break
            except Exception as error:
                logError(error)
